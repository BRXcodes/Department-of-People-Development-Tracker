...
const DEN_CITIES_NORTH = ['Fort Collins', 'Loveland', 'Greeley', 'Longmont', 'Boulder', 'Thornton']
const DEN_CITIES_EAST = ['Brighton', 'Fort Lupton', 'Aurora', 'Commerce City', 'Parker']
const DEN_CITIES_WEST = ['Evergreen', 'Morrison', 'Idaho Springs', 'Golden', 'Arvada', 'Wheat Ridge']
const DEN_CITIES_SOUTH = ['Castle Rock', 'Littleton', 'Highlands Ranch', 'Lone Tree', 'Centennial', 'Englewood']

// Approximate drive times in minutes between cities (one-way) — Denver.
// Hand-filled from real Colorado geography; adjust as needed. Lookup is
// order-independent (getDriveTime checks both directions), so only one
// direction per pair is stored here.
const DEN_DRIVE_TIMES = {
  // North corridor (far I-25 north + Boulder wildcard + Thornton metro)
  'Fort Collins': { 'Loveland': 20, 'Greeley': 35, 'Longmont': 40, 'Boulder': 50, 'Thornton': 55, 'Brighton': 55, 'Fort Lupton': 50, 'Aurora': 70, 'Commerce City': 62, 'Parker': 85, 'Evergreen': 90, 'Morrison': 78, 'Idaho Springs': 100, 'Golden': 70, 'Arvada': 62, 'Wheat Ridge': 65, 'Castle Rock': 95, 'Littleton': 80, 'Highlands Ranch': 82, 'Lone Tree': 82, 'Centennial': 78, 'Englewood': 72 },
  'Loveland': { 'Fort Collins': 20, 'Greeley': 30, 'Longmont': 25, 'Boulder': 40, 'Thornton': 45, 'Brighton': 45, 'Fort Lupton': 40, 'Aurora': 60, 'Commerce City': 52, 'Parker': 75, 'Evergreen': 80, 'Morrison': 68, 'Idaho Springs': 90, 'Golden': 60, 'Arvada': 52, 'Wheat Ridge': 55, 'Castle Rock': 85, 'Littleton': 70, 'Highlands Ranch': 72, 'Lone Tree': 72, 'Centennial': 68, 'Englewood': 62 },
  'Greeley': { 'Fort Collins': 35, 'Loveland': 30, 'Longmont': 40, 'Boulder': 55, 'Thornton': 45, 'Brighton': 40, 'Fort Lupton': 30, 'Aurora': 55, 'Commerce City': 48, 'Parker': 70, 'Evergreen': 90, 'Morrison': 72, 'Idaho Springs': 100, 'Golden': 65, 'Arvada': 55, 'Wheat Ridge': 58, 'Castle Rock': 85, 'Littleton': 72, 'Highlands Ranch': 75, 'Lone Tree': 72, 'Centennial': 68, 'Englewood': 62 },
  'Longmont': { 'Fort Collins': 40, 'Loveland': 25, 'Greeley': 40, 'Boulder': 22, 'Thornton': 35, 'Brighton': 35, 'Fort Lupton': 30, 'Aurora': 50, 'Commerce City': 40, 'Parker': 65, 'Evergreen': 60, 'Morrison': 52, 'Idaho Springs': 70, 'Golden': 42, 'Arvada': 35, 'Wheat Ridge': 40, 'Castle Rock': 72, 'Littleton': 55, 'Highlands Ranch': 60, 'Lone Tree': 62, 'Centennial': 58, 'Englewood': 52 },
  'Boulder': { 'Fort Collins': 50, 'Loveland': 40, 'Greeley': 55, 'Longmont': 22, 'Thornton': 38, 'Brighton': 45, 'Fort Lupton': 42, 'Aurora': 55, 'Commerce City': 42, 'Parker': 65, 'Evergreen': 55, 'Morrison': 42, 'Idaho Springs': 65, 'Golden': 30, 'Arvada': 30, 'Wheat Ridge': 32, 'Castle Rock': 72, 'Littleton': 48, 'Highlands Ranch': 58, 'Lone Tree': 60, 'Centennial': 55, 'Englewood': 48 },
  'Thornton': { 'Fort Collins': 55, 'Loveland': 45, 'Greeley': 45, 'Longmont': 35, 'Boulder': 38, 'Brighton': 18, 'Fort Lupton': 25, 'Aurora': 28, 'Commerce City': 15, 'Parker': 45, 'Evergreen': 45, 'Morrison': 38, 'Idaho Springs': 55, 'Golden': 32, 'Arvada': 22, 'Wheat Ridge': 25, 'Castle Rock': 55, 'Littleton': 38, 'Highlands Ranch': 42, 'Lone Tree': 40, 'Centennial': 38, 'Englewood': 32 },

  // East
  'Brighton': { 'Fort Collins': 55, 'Loveland': 45, 'Greeley': 40, 'Longmont': 35, 'Boulder': 45, 'Thornton': 18, 'Fort Lupton': 15, 'Aurora': 30, 'Commerce City': 20, 'Parker': 45, 'Evergreen': 55, 'Morrison': 50, 'Idaho Springs': 65, 'Golden': 45, 'Arvada': 32, 'Wheat Ridge': 38, 'Castle Rock': 58, 'Littleton': 48, 'Highlands Ranch': 50, 'Lone Tree': 48, 'Centennial': 45, 'Englewood': 42 },
  'Fort Lupton': { 'Fort Collins': 50, 'Loveland': 40, 'Greeley': 30, 'Longmont': 30, 'Boulder': 42, 'Thornton': 25, 'Brighton': 15, 'Aurora': 35, 'Commerce City': 25, 'Parker': 50, 'Evergreen': 60, 'Morrison': 52, 'Idaho Springs': 70, 'Golden': 48, 'Arvada': 38, 'Wheat Ridge': 42, 'Castle Rock': 62, 'Littleton': 52, 'Highlands Ranch': 55, 'Lone Tree': 52, 'Centennial': 48, 'Englewood': 45 },
  'Aurora': { 'Fort Collins': 70, 'Loveland': 60, 'Greeley': 55, 'Longmont': 50, 'Boulder': 55, 'Thornton': 28, 'Brighton': 30, 'Fort Lupton': 35, 'Commerce City': 22, 'Parker': 25, 'Evergreen': 45, 'Morrison': 38, 'Idaho Springs': 60, 'Golden': 40, 'Arvada': 35, 'Wheat Ridge': 30, 'Castle Rock': 40, 'Littleton': 30, 'Highlands Ranch': 30, 'Lone Tree': 25, 'Centennial': 22, 'Englewood': 25 },
  'Commerce City': { 'Fort Collins': 62, 'Loveland': 52, 'Greeley': 48, 'Longmont': 40, 'Boulder': 42, 'Thornton': 15, 'Brighton': 20, 'Fort Lupton': 25, 'Aurora': 22, 'Parker': 40, 'Evergreen': 45, 'Morrison': 38, 'Idaho Springs': 58, 'Golden': 32, 'Arvada': 25, 'Wheat Ridge': 25, 'Castle Rock': 52, 'Littleton': 35, 'Highlands Ranch': 40, 'Lone Tree': 38, 'Centennial': 35, 'Englewood': 30 },
  'Parker': { 'Fort Collins': 85, 'Loveland': 75, 'Greeley': 70, 'Longmont': 65, 'Boulder': 65, 'Thornton': 45, 'Brighton': 45, 'Fort Lupton': 50, 'Aurora': 25, 'Commerce City': 40, 'Evergreen': 50, 'Morrison': 40, 'Idaho Springs': 68, 'Golden': 45, 'Arvada': 48, 'Wheat Ridge': 42, 'Castle Rock': 22, 'Littleton': 28, 'Highlands Ranch': 20, 'Lone Tree': 15, 'Centennial': 18, 'Englewood': 25 },

  // West (foothills / canyon towns)
  'Evergreen': { 'Fort Collins': 90, 'Loveland': 80, 'Greeley': 90, 'Longmont': 60, 'Boulder': 55, 'Thornton': 45, 'Brighton': 55, 'Fort Lupton': 60, 'Aurora': 45, 'Commerce City': 45, 'Parker': 50, 'Morrison': 20, 'Idaho Springs': 25, 'Golden': 25, 'Arvada': 35, 'Wheat Ridge': 32, 'Castle Rock': 45, 'Littleton': 32, 'Highlands Ranch': 35, 'Lone Tree': 40, 'Centennial': 38, 'Englewood': 35 },
  'Morrison': { 'Fort Collins': 78, 'Loveland': 68, 'Greeley': 72, 'Longmont': 52, 'Boulder': 42, 'Thornton': 38, 'Brighton': 50, 'Fort Lupton': 52, 'Aurora': 38, 'Commerce City': 38, 'Parker': 40, 'Evergreen': 20, 'Idaho Springs': 40, 'Golden': 15, 'Arvada': 25, 'Wheat Ridge': 20, 'Castle Rock': 42, 'Littleton': 18, 'Highlands Ranch': 25, 'Lone Tree': 30, 'Centennial': 25, 'Englewood': 20 },
  'Idaho Springs': { 'Fort Collins': 100, 'Loveland': 90, 'Greeley': 100, 'Longmont': 70, 'Boulder': 65, 'Thornton': 55, 'Brighton': 65, 'Fort Lupton': 70, 'Aurora': 60, 'Commerce City': 58, 'Parker': 68, 'Evergreen': 25, 'Morrison': 40, 'Golden': 35, 'Arvada': 45, 'Wheat Ridge': 42, 'Castle Rock': 65, 'Littleton': 50, 'Highlands Ranch': 52, 'Lone Tree': 58, 'Centennial': 55, 'Englewood': 50 },
  'Golden': { 'Fort Collins': 70, 'Loveland': 60, 'Greeley': 65, 'Longmont': 42, 'Boulder': 30, 'Thornton': 32, 'Brighton': 45, 'Fort Lupton': 48, 'Aurora': 40, 'Commerce City': 32, 'Parker': 45, 'Evergreen': 25, 'Morrison': 15, 'Idaho Springs': 35, 'Arvada': 18, 'Wheat Ridge': 15, 'Castle Rock': 50, 'Littleton': 25, 'Highlands Ranch': 32, 'Lone Tree': 38, 'Centennial': 32, 'Englewood': 25 },
  'Arvada': { 'Fort Collins': 62, 'Loveland': 52, 'Greeley': 55, 'Longmont': 35, 'Boulder': 30, 'Thornton': 22, 'Brighton': 32, 'Fort Lupton': 38, 'Aurora': 35, 'Commerce City': 25, 'Parker': 48, 'Evergreen': 35, 'Morrison': 25, 'Idaho Springs': 45, 'Golden': 18, 'Wheat Ridge': 10, 'Castle Rock': 55, 'Littleton': 28, 'Highlands Ranch': 38, 'Lone Tree': 42, 'Centennial': 35, 'Englewood': 28 },
  'Wheat Ridge': { 'Fort Collins': 65, 'Loveland': 55, 'Greeley': 58, 'Longmont': 40, 'Boulder': 32, 'Thornton': 25, 'Brighton': 38, 'Fort Lupton': 42, 'Aurora': 30, 'Commerce City': 25, 'Parker': 42, 'Evergreen': 32, 'Morrison': 20, 'Idaho Springs': 42, 'Golden': 15, 'Arvada': 10, 'Castle Rock': 50, 'Littleton': 22, 'Highlands Ranch': 32, 'Lone Tree': 35, 'Centennial': 30, 'Englewood': 22 },

  // South
  'Castle Rock': { 'Fort Collins': 95, 'Loveland': 85, 'Greeley': 85, 'Longmont': 72, 'Boulder': 72, 'Thornton': 55, 'Brighton': 58, 'Fort Lupton': 62, 'Aurora': 40, 'Commerce City': 52, 'Parker': 22, 'Evergreen': 45, 'Morrison': 42, 'Idaho Springs': 65, 'Golden': 50, 'Arvada': 55, 'Wheat Ridge': 50, 'Littleton': 32, 'Highlands Ranch': 25, 'Lone Tree': 22, 'Centennial': 28, 'Englewood': 32 },
  'Littleton': { 'Fort Collins': 80, 'Loveland': 70, 'Greeley': 72, 'Longmont': 55, 'Boulder': 48, 'Thornton': 38, 'Brighton': 48, 'Fort Lupton': 52, 'Aurora': 30, 'Commerce City': 35, 'Parker': 28, 'Evergreen': 32, 'Morrison': 18, 'Idaho Springs': 50, 'Golden': 25, 'Arvada': 28, 'Wheat Ridge': 22, 'Castle Rock': 32, 'Highlands Ranch': 15, 'Lone Tree': 18, 'Centennial': 15, 'Englewood': 15 },
  'Highlands Ranch': { 'Fort Collins': 82, 'Loveland': 72, 'Greeley': 75, 'Longmont': 60, 'Boulder': 58, 'Thornton': 42, 'Brighton': 50, 'Fort Lupton': 55, 'Aurora': 30, 'Commerce City': 40, 'Parker': 20, 'Evergreen': 35, 'Morrison': 25, 'Idaho Springs': 52, 'Golden': 32, 'Arvada': 38, 'Wheat Ridge': 32, 'Castle Rock': 25, 'Littleton': 15, 'Lone Tree': 12, 'Centennial': 12, 'Englewood': 18 },
  'Lone Tree': { 'Fort Collins': 82, 'Loveland': 72, 'Greeley': 72, 'Longmont': 62, 'Boulder': 60, 'Thornton': 40, 'Brighton': 48, 'Fort Lupton': 52, 'Aurora': 25, 'Commerce City': 38, 'Parker': 15, 'Evergreen': 40, 'Morrison': 30, 'Idaho Springs': 58, 'Golden': 38, 'Arvada': 42, 'Wheat Ridge': 35, 'Castle Rock': 22, 'Littleton': 18, 'Highlands Ranch': 12, 'Centennial': 10, 'Englewood': 15 },
  'Centennial': { 'Fort Collins': 78, 'Loveland': 68, 'Greeley': 68, 'Longmont': 58, 'Boulder': 55, 'Thornton': 38, 'Brighton': 45, 'Fort Lupton': 48, 'Aurora': 22, 'Commerce City': 35, 'Parker': 18, 'Evergreen': 38, 'Morrison': 25, 'Idaho Springs': 55, 'Golden': 32, 'Arvada': 35, 'Wheat Ridge': 30, 'Castle Rock': 28, 'Littleton': 15, 'Highlands Ranch': 12, 'Lone Tree': 10, 'Englewood': 15 },
  'Englewood': { 'Fort Collins': 72, 'Loveland': 62, 'Greeley': 62, 'Longmont': 52, 'Boulder': 48, 'Thornton': 32, 'Brighton': 42, 'Fort Lupton': 45, 'Aurora': 25, 'Commerce City': 30, 'Parker': 25, 'Evergreen': 35, 'Morrison': 20, 'Idaho Springs': 50, 'Golden': 25, 'Arvada': 28, 'Wheat Ridge': 22, 'Castle Rock': 32, 'Littleton': 15, 'Highlands Ranch': 18, 'Lone Tree': 15, 'Centennial': 15 },
}
