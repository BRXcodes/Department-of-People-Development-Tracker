    ...
    <header className="header">
      <div className="header-inner">
        <div className="header-top">
          ...
          <button className="btn btn-ghost btn-icon" onClick={onOpenNotify} title="Reminders">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="team-tabs">          {teams.map(team => (
            <div key={team.id} className={`team-tab ${team.id === activeTeamId && view !== 'attendance' ? 'active' : ''}`}>
          ...
          <div className={`team-tab ${view === 'attendance' ? 'active' : ''}`}>
            <button className="team-tab-btn" onClick={() => setView('attendance')}>
              Attendance
            </button>
          </div>
          ...
          <div className={`team-tab ${view === 'slc' ? 'active' : ''}`}>
            <button className="team-tab-btn" onClick={() => setView('slc')}>
              SLC Calendar
            </button>
          </div>
          {isManager && (
